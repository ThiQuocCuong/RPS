...
#ifndef __RPS__FriendLayer__
#define __RPS__FriendLayer__

#include "GameLayer.h"
#include "../Cell/FriendCell.h"
class FriendLayer : public GameLayer, cocos2d::extension::TableViewDataSource, cocos2d::extension::TableViewDelegate {
...
#endif /* defined(__RPS__FriendLayer__) */

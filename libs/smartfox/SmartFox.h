...
namespace Sfs2X {
	...
	public:
		...
		/// 
		/// <remark>
		/// This method must be called once to dispose all resources used by a SmartFox instance that is exiting. <br/>
		/// </remark>
		/// 
		/// </overloads>		
		void Dispose();
		...
		/// </example>
		/// 
		/// <seealso cref="SFSEvent.CRYPTO_INIT"/>
		void InitCrypto();
	...
	private:
		...
		void CleanEventParams(boost::shared_ptr<BaseEvent> e);

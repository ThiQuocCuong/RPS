...
namespace Bitswarm {
	...
	public:
		...
		BitSwarmClient();
		BitSwarmClient(boost::shared_ptr<SmartFox> sfs);
		...
		void Dispatcher(boost::shared_ptr<Util::EventDispatcher> value);
		boost::shared_ptr<Logger> Log();
		boost::shared_ptr<Sfs2X::Util::CryptoKey> CryptoKey();
		void CryptoKey(boost::shared_ptr<Sfs2X::Util::CryptoKey> value);
		...
		boost::shared_ptr<Util::EventDispatcher> Dispatcher();
	...
	private:
		...
		boost::shared_ptr<boost::asio::io_service> io_service_retryTimer;
